...
class AddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.client_create(wd, Contact(firstname = "Petrov", middlename = "Petr", lastname = "Petrovich", nickname = "Ppp1", title = "Rere", company = "OooPetrov", address = "Petrova1-42",
    ...
    def client_create(self, wd, contact):
        # client creation
